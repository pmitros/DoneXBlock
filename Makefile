...
quality: ## check coding style with pycodestyle and pylint
	pycodestyle done --max-line-length=120
	pylint done
...
extract_translations: ## extract strings to be translated, outputting .po files
	...
	mkdir -p done/translations/en/LC_MESSAGES/
	rm -f done/translations/en/LC_MESSAGES/*
	django-admin makemessages -l en -v1 -d django
	mv done/translations/en/LC_MESSAGES/django.po done/translations/en/LC_MESSAGES/text.po
